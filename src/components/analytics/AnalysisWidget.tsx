...
export const AnalysisWidget = ({ isOpen, onClose, selectedSymbol = "AAPL", onSymbolSelect }: AnalysisWidgetProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div 
        className={`relative bg-gradient-to-br from-gray-900 via-slate-900 to-black shadow-2xl border border-gray-700 ${
          isMaximized 
      ...
      >
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('/lovable-uploads/13f32a61-cd76-4575-a86f-b6b865d4f745.png')`
          }}
        />

        {/* Header with Professional Finance Theme */}
        <div className="relative bg-gradient-to-r from-slate-900 via-gray-900 to-slate-900 text-white border-b border-gray-600 rounded-t-xl overflow-hidden">
        ...
        {/* Main Content Area */}
        <div className="flex flex-col h-full bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-sm">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
            {/* Enhanced Tab Navigation */}
            <div className="bg-gray-900/80 border-b border-gray-600 shadow-sm backdrop-blur-sm">
              <TabsList className="w-full bg-transparent p-0 h-auto">
                <div className="grid w-full grid-cols-7 divide-x divide-gray-600">
                  {[
                    ...
                    <TabsTrigger 
                      ...
                      className={`
                        ...
                        data-[state=active]:from-blue-900/50 
                        data-[state=active]:to-purple-900/50
            ...
            <div className="flex-1 overflow-hidden">
              <div className="h-full overflow-y-auto">
                <TabsContent value="builder" className="h-full m-0 p-8 space-y-6">
                  <div className="mb-8">
                    <h2 className="text-3xl font-bold text-white mb-3">Portfolio Builder</h2>
                    <p className="text-gray-300 text-lg">Build and optimize your investment portfolio with advanced allocation tools and risk management.</p>
                  </div>
                  <PortfolioBuilder />
                </TabsContent>
                ...
                <TabsContent value="manager" className="h-full m-0 p-8 space-y-6">
                  <div className="mb-8">
                    <h2 className="text-3xl font-bold text-white mb-3">Portfolio Manager</h2>
                    <p className="text-gray-300 text-lg">Manage and track your investment portfolios with real-time monitoring and performance analytics.</p>
                  </div>
                  <PortfolioManager />
                </TabsContent>
                ...
                <TabsContent value="screener" className="h-full m-0 p-8 space-y-6">
                  <div className="mb-8">
                    <h2 className="text-3xl font-bold text-white mb-3">Stock Screener</h2>
                    <p className="text-gray-300 text-lg">Discover investment opportunities with advanced filtering, technical analysis, and fundamental screening.</p>
                  </div>
                  <StockScreener />
                </TabsContent>
                ...
                <TabsContent value="analytics" className="h-full m-0 p-8 space-y-6">
                  <div className="mb-8">
                    <h2 className="text-3xl font-bold text-white mb-3">Portfolio Analytics</h2>
                    <p className="text-gray-300 text-lg">Advanced quantitative analysis, risk metrics, and performance attribution for your investments.</p>
                  </div>
                  <PortfolioAnalytics />
                </TabsContent>
                ...
                <TabsContent value="quantlab" className="h-full m-0 p-8 space-y-6">
                  <div className="mb-8">
                    <h2 className="text-3xl font-bold text-white mb-3">Quantitative Lab</h2>
                    <p className="text-gray-300 text-lg">Research environment for algorithmic trading, quantitative analysis, and strategy development.</p>
                  </div>
                  <QuantLab />
                </TabsContent>
                ...
                <TabsContent value="simulator" className="h-full m-0 p-8 space-y-6">
                  <div className="mb-8">
                    <h2 className="text-3xl font-bold text-white mb-3">Portfolio Simulator</h2>
                    <p className="text-gray-300 text-lg">Test your strategies against historical scenarios, stress tests, and market conditions.</p>
                  </div>
                  <PortfolioSimulator />
                </TabsContent>
                ...
                <TabsContent value="marketdata" className="h-full m-0 p-8 space-y-6">
                  <div className="mb-8">
                    <h2 className="text-3xl font-bold text-white mb-3">Market Data Terminal</h2>
                    <p className="text-gray-300 text-lg">Real-time market data, comprehensive security information, and advanced charting tools.</p>
                  </div>
                  <TerminalMarketData 
